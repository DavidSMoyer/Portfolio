...
export default function About(props)
{
    ...
    return (
        <div id="about">
            ...
            <main>
                <h1>David Scott Moyer - Software Developer</h1>
                <hr />
                <p>
                    Hey there! My name is David Moyer, I use They/Them, and I'm an aspiring Software Developer. I am also a graduated student of both Pembina Trails Early College and the Manitoba Institution of Trades and Technology since 2022.
                </p>
                <p>
