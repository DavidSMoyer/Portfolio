...
export default function Nav(props) 
{
    ...
    return (
        <div id="nav-grid">
            ...
            <NavElement id="nav-projects" title="Projects" icon="laptop-code" onClick={() => { StartTransition("right", () => navigate("/")); props.setLoad("#979797", "#ffffff", "laptop-code");}}  />
            ...
            <NavElement id="nav-contact" title="Contact" icon="envelope" onClick={() => { StartTransition("right", () => navigate("/")); props.setLoad("#0f0f0f", "#2c2c2c", "envelope");}} />
        </div>
    )
}